...
casting1.save()
casting2 = Casting.new({ 'star_id' => star1.id, 'movie_id' => movie2.id, 'fee' => 500000})
casting2.save()
casting3 = Casting.new({ 'star_id' => star2.id, 'movie_id' => movie3.id, 'fee' => 9000000})
casting3.save()
casting4 = Casting.new({ 'star_id' => star3.id, 'movie_id' => movie1.id, 'fee' => 1000000})
casting4.save()
